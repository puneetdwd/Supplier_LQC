        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="button normals btn-circle" href="<?php echo base_url()."lqc_plan/add_checkpoint"; ?>">
                            <i class="fa fa-plus"></i> Add New Checkpoint
                        </a>

                        <a class="button normals btn-circle" href="<?php echo base_url()."lqc_plan/upload_checkpoints"; ?>">
                            <i class="fa fa-plus"></i> Upload Checkpoints
                        </a>
						<?php if(!empty($checkpoints)) { ?>
							<a class="button normals btn-circle" href="<?php echo base_url()."lqc_plan/download_checkpoints"; ?>">
                                    ...
                                    <?php foreach($checkpoints as $checkpoint) { ?>
                                        <tr class="checkpoint-<?php echo $checkpoint['id']; ?>">
                                            ...
                                            <td nowrap class="text-center">
                                                <a class="button small gray" href="<?php echo base_url()."lqc_plan/add_checkpoint/".$checkpoint['id']; ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>

                                                <a class="btn btn-outline btn-xs sbold red-thunderbird" href="<?php echo base_url()."lqc_plan/delete_checkpoint/".$checkpoint['id']; ?>" data-confirm="Are you sure you want to delete this checkpoint?">

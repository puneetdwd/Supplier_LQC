<div class="page-content">
    ...
    <div class="breadcrumbs">
        <h1>
            <?php echo (isset($plan) ? 'Edit': 'Add'); ?>  Plan
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active"><?php echo (isset($plan) ? 'Edit': 'Add'); ?> Plan</li>
        </ol>
                            ...
                            <div class="row production-row">
                                <div class="col-md-6">
                                    <div class="form-group" id="report-sel-part-error">
                                        ...
                                        <select name="part_id" class="required form-control select2me" data-placeholder="Select Part" data-error-container="#report-sel-part-error">
                                            <option></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="report-sel-part-error">
                                        <label class="control-label">Lot Size:
                                        <span class="required"> * </span></label>
                                                
                                        <input type="text" class="required form-control" id="lot_size" name="lot_size"
                                        value="<?php echo isset($plan['lot_size']) ? $plan['lot_size'] : ''; ?>">

<div class="page-content">
    ...
    <div class="breadcrumbs">
        <h1>
            <?php echo (isset($user) ? 'Edit': 'Add'); ?> Inspector
        </h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li>
                <a href="<?php echo base_url()."suppliers/view"; ?>">Manage Inspector</a>
            </li>
            <li class="active"><?php echo (isset($user) ? 'Edit': 'Add'); ?> Inspector</li>
        </ol>
                    ...
                    <form role="form" class="validate-form" method="post">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Inspector ID
                                        <span class="required">*</span></label>

...
<div class="page-content">
    ...
    <div class="breadcrumbs">
        <h1>
            Manage Part Defect Mapping
        </h1>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url(); ?>">Home</a>
            </li>
            <li class="active">Manage Part Defect Mapping</li>
        </ol>
    </div>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="button normals btn-circle" href="<?php echo base_url()."products/add_pd_mapping"; ?>">
                ...
                <div class="portlet-body">
                    ...
                    <?php if(empty($mappings)) { ?>
                        <p class="text-center">No Defect Code.</p>
                    <?php } else { ?>
                                ...
                                <tbody>
									...
									foreach($mappings as $mapping) { ?>
                                        ...
                                        <tr class="checkpoint-<?php echo $mapping['id']; ?>">
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $mapping['product_name']; ?></td>
                                            <td><?php echo $mapping['part_name'] ? $mapping['part_name'] : '--'; ?></td>
                                            <td><?php echo $mapping['part_no']; ?></td>
                                            <td><?php echo $mapping['supplier_name']; ?></td>
                                            <td><?php echo $mapping['defect_description'] ."(".$mapping['defect_description_detail'].")"; ?></td>
                                           
                                            <td nowrap class="text-center">
                                                    <a class="button small gray" href="<?php echo base_url()."products/add_pd_mapping/".$mapping['id']; ?>">
                                                        <i class="fa fa-edit"></i> Edit
                                                    </a>

                                                    <a class="btn btn-outline btn-xs sbold red-thunderbird" href="<?php echo base_url()."products/delete_pd_mapping/".$mapping['id']; ?>" data-confirm="Are you sure you want to delete this Defect Code?">

                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
						...
						<?php if(!empty($approval_items)) { ?>
							<a href='<?php echo base_url()."fool_proof/change_checkpoints_status_all/Approved" ?>' class="button" type="submit">Approve All</a>
							<a href='<?php echo base_url()."fool_proof/change_checkpoints_status_all/Declined" ?>' class="button" type="submit">Decline All</a>
						<?php } ?>
                    </div>
                </div>

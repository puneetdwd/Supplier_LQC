                                    ...
                                    <tr style="background-color:inherit;">
                                        ...
                                        <td nowrap>
                                            <a class="button small" 
                                                href="<?php echo base_url()."auditer/continue_inspection_lqc";?>">
                                                Resume
                                            </a>
                                            
                                            <a class="button small" href="<?php echo base_url().'auditer/mark_as_abort_lqc/';?>" data-confirm="Are you sure  you want to cancel this inspection?">
                                                Abort
                                            </a>
                                            
                                            <a class="button small" href="<?php echo base_url().'auditer/on_hold_lqc/'.$on_going['id'];?>" data-confirm="Are you sure  you want to mark this inspection ON HOLD?">
                                                On Hold
                                            </a>
                                        </td>
                                    </tr>
